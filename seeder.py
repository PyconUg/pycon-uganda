...
try:
    # Handle migrations
    call_command("makemigrations", "home", "cms", "coc", "fin_aid", "registration", 
                "talks", "about", "conference_schedule", "health_safety_guideline",
                "privacypolicy", "speakers", "sponsor_us", "tickets", "travel_guide")
