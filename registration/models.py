...
class Profile(models.Model, HitCountMixin):
    ...
    city = models.CharField(max_length=100, default="", blank=False, help_text="City the speaker is from eg. Kampala")
    country = CountryField(default="UG", blank=False, blank_label='(select country)')
    contact_number = models.CharField(max_length=50, help_text="Please include your country code (256).", default="", blank=True, null=True)
    website = models.URLField(max_length=200, help_text="Your website/blog URL.", null=True, blank=True)
    twitter_handle = models.CharField(max_length=100, null=True, help_text="Please enter only the user name eg.'your_user_name'", default="", blank=True)
    github_username = models.CharField(max_length=100, null=True, help_text="Please enter only the user name eg.'your_user_name'", default="", blank=True)
